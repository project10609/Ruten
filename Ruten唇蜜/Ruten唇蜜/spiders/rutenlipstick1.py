...
class Rutenlipstick1Spider(scrapy.Spider):
    name = 'rutenlipstick1'
    start_urls = ['https://find.ruten.com.tw/c/0012000500030002/']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500030002?p=' + \
            str(Rutenlipstick1Spider.page)
        if Rutenlipstick1Spider.page <= 4:
            # self.action.pause(1)
            # self.action.perform()
            Rutenlipstick1Spider.page += 1
            url = next_page
