...
class RuteneyebrowSpider(scrapy.Spider):
    name = 'ruteneyebrow'

    start_urls = ['https://find.ruten.com.tw/c/0012000500020004']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500020004?p=' + str(RuteneyebrowSpider.page)
        if RuteneyebrowSpider.page <= 10:
                # self.action.pause(1)
                # self.action.perform()
            RuteneyebrowSpider.page += 1
            url = next_page
