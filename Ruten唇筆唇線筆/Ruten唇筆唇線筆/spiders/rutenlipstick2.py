...
class Rutenlipstick2Spider(scrapy.Spider):
    name = 'rutenlipstick2'
    start_urls = ['https://find.ruten.com.tw/c/0012000500030003/']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500030003?p=' + \
            str(Rutenlipstick2Spider.page)
        if Rutenlipstick2Spider.page <= 4:
            # self.action.pause(1)
            # self.action.perform()
            Rutenlipstick2Spider.page += 1
            url = next_page
    ...
    def parse_item(self, response):
        ...
        item['product_subcategory'] = 'LipPencil'
