...
class RutenmakeuptoolsSpider(scrapy.Spider):
    name = 'rutenmakeuptools'

    start_urls = ['https://find.ruten.com.tw/c/001200050007']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/001200050007?p=' + str(RutenmakeuptoolsSpider.page)
        if RutenmakeuptoolsSpider.page <= 10:
                # self.action.pause(1)
                # self.action.perform()
            RutenmakeuptoolsSpider.page += 1
            url = next_page
