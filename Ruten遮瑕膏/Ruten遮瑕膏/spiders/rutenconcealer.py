...
class RutenconcealerSpider(scrapy.Spider):
    name = 'rutenconcealer'

    start_urls = ['https://find.ruten.com.tw/c/0012000500010004']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500010004?p=' + str(RutenconcealerSpider.page)
