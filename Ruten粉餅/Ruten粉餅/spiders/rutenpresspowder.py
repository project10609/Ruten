...
class RutenpresspowderSpider(scrapy.Spider):
    name = 'rutenpresspowder'

    start_urls = ['https://find.ruten.com.tw/c/0012000500010008']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500010008?p=' + str(RutenpresspowderSpider.page)
        if RutenpresspowderSpider.page <= 10:
                # self.action.pause(1)
                # self.action.perform()
            RutenpresspowderSpider.page += 1
            url = next_page
