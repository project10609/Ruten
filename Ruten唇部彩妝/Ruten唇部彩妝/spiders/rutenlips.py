...
class RutenlipsSpider(scrapy.Spider):
    name = 'rutenlips'

    start_urls = ['https://find.ruten.com.tw/c/001200050003?p=1']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/001200050003?p=' + str(RutenlipsSpider.page)
        if RutenlipsSpider.page <= 10:
                # self.action.pause(1)
                # self.action.perform()
            RutenlipsSpider.page += 1
            url = next_page
