...
class RutenlipstickSpider(scrapy.Spider):
    name = 'rutenlipstick'
    start_urls = ['https://find.ruten.com.tw/c/0012000500030001/']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500030001?p=' + \
            str(RutenlipstickSpider.page)
        if RutenlipstickSpider.page <= 4:
            # self.action.pause(1)
            # self.action.perform()
            RutenlipstickSpider.page += 1
            url = next_page
