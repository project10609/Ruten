...
class RutenmascaraSpider(scrapy.Spider):
    name = 'rutenmascara'

    start_urls = ['https://find.ruten.com.tw/c/0012000500020002']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500020002?p=' + str(RutenmascaraSpider.page)
        if RutenmascaraSpider.page <= 10:
                # self.action.pause(1)
                # self.action.perform()
            RutenmascaraSpider.page += 1
            url = next_page
    ...
    def parse_item(self,response):
        ...
        item['product_images'] = os.path.basename(img[0])
