...
class RutenblushSpider(scrapy.Spider):
    name = 'rutenblush'

    start_urls = ['https://find.ruten.com.tw/c/0012000500010005']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500010005?p=' + str( RutenblushSpider.page)
        if  RutenblushSpider.page <= 10:
                # self.action.pause(1)
                # self.action.perform()
             RutenblushSpider.page += 1
            url = next_page
