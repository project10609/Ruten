...
class RutenpowderSpider(scrapy.Spider):
    name = 'rutenpowder'

    start_urls = ['https://find.ruten.com.tw/c/0012000500010003']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500010003?p=' + \
            str(RutenpowderSpider.page)
        if RutenpowderSpider.page <= 10:
            # self.action.pause(1)
            # self.action.perform()
            RutenpowderSpider.page += 1
            url = next_page
    ...
    def parse_item(self, response):
        ...
        item['product_subcategory'] = 'loosepowder'
