...
class Rutenlipstick3Spider(scrapy.Spider):
    name = 'rutenlipstick3'
    start_urls = ['https://find.ruten.com.tw/c/0012000500030005/']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500030005?p=' + \
            str(Rutenlipstick3Spider.page)
        if Rutenlipstick3Spider.page <= 4:
            # self.action.pause(1)
            # self.action.perform()
            Rutenlipstick3Spider.page += 1
            url = next_page
