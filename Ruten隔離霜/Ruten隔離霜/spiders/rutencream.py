...
class RutencreamSpider(scrapy.Spider):
    name = 'rutencream'

    start_urls = ['https://find.ruten.com.tw/c/0012000500010001']
    ...
    def parse(self, response):
        ...
        next_page = 'https://find.ruten.com.tw/c/0012000500010001?p=' + str(RutencreamSpider.page)
